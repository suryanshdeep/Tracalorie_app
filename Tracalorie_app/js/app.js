class CalorieTracker{
    constructor(){
        ...
        //for showing the form field of calorie limit to current value by default
...
class Storage{
    ...
    static clearAll(){
        ...
        //if you also want to reset the calorieLimit
        //localStorage.clear();
    }
}
...
class App{
    ...
    _loadEventListeners(){
        ...
        document.getElementById('meal-items').addEventListener('click',
            this._removeItems.bind(this,'meal'));
        document.getElementById('workout-items').addEventListener('click',
            this._removeItems.bind(this,'workout'));
